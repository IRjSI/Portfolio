...
function Home() {
  return (
    <div id="home" className="flex flex-col lg:flex-row items-center justify-center p-4">
      <img
        className="
        shadow-blue-400 shadow-lg hover:shadow-xl hover:shadow-blue-400 transition
      ...
      <div className="text-center lg:text-left text-4xl lg:text-5xl">
        <p className="flex flex-wrap justify-center lg:justify-start text-white">
          I am an aspiring&nbsp;
          <span className="text-yellow-300 font-dancing text-5xl lg:text-6xl hover:text-yellow-400 hover:animate-pulse ">
            Web Developer
          </span>
        </p>
      </div>
