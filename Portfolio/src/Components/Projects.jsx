...
function Projects() {
  return (
    <div id="projects" className="p-4">
      <p className="text-yellow-300 text-5xl text-center font-dancing m-8">
        Projects
      </p>
      
      <div className="text-white text-center text-2xl sm:text-3xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 items-center justify-center p-4">
