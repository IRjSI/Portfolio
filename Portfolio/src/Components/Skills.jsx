    ...
    <div id="skills" className="p-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 p-4 px-24">
        ...
        <button className="relative inline-flex h-12 overflow-hidden rounded-2xl p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 hover:rounded-lg hover:transition-all transition-all">
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-2xl bg-[#1f2937] px-4 py-1 text-lg font-bold text-white backdrop-blur-3xl hover:rounded-lg hover:transition-all transition-all">
        ...
        <button className="relative inline-flex h-12 overflow-hidden rounded-2xl p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 hover:rounded-lg hover:transition-all transition-all">
            <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-2xl hover:rounded-lg hover:transition-all bg-[#1f2937] px-4 py-1 text-lg font-bold text-white backdrop-blur-3xl transition-all">
